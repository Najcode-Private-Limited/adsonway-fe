            ...
            <DialogContent className="min-w-[600px] max-w-3xl max-h-[90vh] p-0 overflow-hidden bg-zinc-950 border-zinc-800">
                ...
                <div className="h-[calc(90vh-140px)] overflow-y-auto custom-scrollbar">
                    <div className="p-8 space-y-8">
                                ...
                                <Card className="bg-zinc-900 border-zinc-800 shadow-sm">
                                    <CardContent className="p-4 space-y-3">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-zinc-100 font-medium">{data.user?.full_name || "N/A"}</span>
                                        </div>
                                        <div className="flex flex-col">
                                            <span className="text-xs text-zinc-500">Email Address</span>
                                            <div className="flex items-center justify-between group">
                                                <span className="text-zinc-200">{data.user?.email || "N/A"}</span>
                                                <Button size="icon" variant="ghost" className="h-6 w-6 opacity-0 group-hover:opacity-100 transition-opacity" onClick={() => copyToClipboard(data.user?.email, "Email")}>
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-indigo-400 font-mono">@{data.user?.username || "N/A"}</span>
                                        </div>
                                    </CardContent>
                                </Card>
                            </div>
                        ...
                        {/* Additional Details Section (Condensed) */}
                        <div className="space-y-4">
                            <h3 className="text-sm font-bold text-zinc-400 uppercase tracking-widest flex items-center gap-2">
                            ...
                            <Card className="bg-zinc-900 border-zinc-800">
                                <CardContent className="p-4 grid grid-cols-2 md:grid-cols-3 gap-6">
                                    <div className="space-y-1">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex justify-between items-end">
                                            ...
                                            <div className="text-right">
                                                <span className="text-2xl font-black bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400">
                                                    ${totalPaid.toFixed(2)}
                                                </span>
                                            </div>
                                        </div>
